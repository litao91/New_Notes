...
```
.\build\mvn -Pyarn -Phadoop-2.6 -Dhadoop.version=2.6.0 -DwildcardSuites=none -Dtest=org.apache.spark.util.MutableURLClassLoaderSuite test >> core.MutableURLClassLoaderSuit.testout.txt 2>&1
```
